...
class User(Base, TimestampMixin):
    ...
    last_duel: Mapped[Optional[datetime]] = mapped_column(DateTime(timezone=True), nullable=True)
    ...
    total_boss_damage: Mapped[int] = mapped_column(BigInteger, default=0)
    ...
    ui_lang: Mapped[Optional[str]] = mapped_column(String(2), nullable=True)
